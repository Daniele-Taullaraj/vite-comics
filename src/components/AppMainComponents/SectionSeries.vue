    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col position-relative">
                ...
                <div class="banner position-absolute top-0 start-0 translate-middle-y">
                    <h6 class="m-0 px-3 py-2 ">CURRENT SERIES</h6>
                </div>

                <div class="row pb-5 mb-5">
                    <div v-for="card in fumetti" class="col-2 pt-5">
                        <img :src="card.thumb" alt="">
                        <h6 class="pt-2 m-0">{{ card.series }}</h6>
                    </div>
                </div>

                <button
                    class="position-absolute bottom-0 start-50 translate-middle-x border-0 text-white py-1 px-5 mb-3">
                    LOAD MORE
                </button>
